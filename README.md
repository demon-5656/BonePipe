# 🦴 BonePipe v3.0.12 - Stable Release
...
BonePipe — мод для Minecraft 1.19.2 Forge, реализующий беспроводную передачу предметов, жидкостей и газов между адаптерами по частотам. Поддержка Mekanism Gas, базовая фильтрация, настройка режимов каналов и частоты передачи.
...
**Новое в v3.0.12:**
- Исправлено сохранение конфигурации адаптера (режимы каналов, частота, владелец)
- Исправлен критический баг с NPE при загрузке мира
...
### v3.0.12 - Stable Release (2025-10-24)
- Исправлено: сохранение конфигурации адаптера (режимы каналов, частота, владелец)
- Исправлено: критический баг с NPE при загрузке мира
